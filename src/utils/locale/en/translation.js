export const en = {
  ...
  about: {
    ...
    biography: "Biography",
    about_job: `私はフロントエンド開発者を目指しており、ウェブ開発と継続的な学習に強い情熱を持っています。まだフルタイムの職務経験はありませんが、これまでにいくつかの個人プロジェクトや学術プロジェクトに取り組み、実践的なスキルを身につけてきました。
    現実のプロジェクトに貢献しながら、プロの開発者として成長したいと強く思っています。経験豊富な開発者から学び、前向きなチームの一員として活躍できる機会を探しています。`,
